...
ComputerLauncher launcher = new new hudson.plugins.sshslaves.SSHLauncher(
        "10.0.40.4", // Host
        22, // Port
        "jenkins-master-key", // Credentials
...
Slave agent = new DumbSlave(
        ...
        "/home/jenkins",
        launcher)
agent.nodeDescription = "Tower slave"
agent.numExecutors = 4
agent.labelString = "php"
...
return "Node tower has been created successfully."
